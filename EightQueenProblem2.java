public class EightQueenProblem2 {
    public static void main(String[] args) {
        int[] qr = new int[8];
        int[] qc = new int[8];
        EightQueenProblem2 chess = new EightQueenProblem2();
        
        do {
            chess.makeGuess(qr, qc);
        }
            
        while(chess.checkGuess(qr, qc) == false);
        
        chess.printGuess(qr, qc);
        
    }  // end of main method
    
    public void makeGuess(int qr[], int qc[]) {
        for(int n = 0; n < 8; n++) {
    ...
    public boolean checkGuess(int qr[], int qc[]) {
    ...
    public void printGuess(int qr[], int qc[]) {
